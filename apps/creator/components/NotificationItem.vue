<template>
  ...
  >
    ...
    <div class="avatar h-10 w-10 flex-shrink-0">
      ...
      <div
        v-else
        class="h-full w-full flex items-center justify-center bg-primary-100 dark:bg-primary-800 text-primary-600 dark:text-primary-400"
      >
    ...
    <div v-if="!notification.isRead" class="flex-shrink-0">
      ...
      <div class="h-2 w-2 rounded-full bg-primary-500 dark:bg-primary-400" />

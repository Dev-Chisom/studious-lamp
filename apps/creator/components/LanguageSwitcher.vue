	...
	<div v-click-outside="closeDropdown" class="relative">
		...
		<div
			...
			<div class="py-1" role="menu">
				<button
					v-for="locale in availableLocales" :key="locale.code" class="block w-full text-left px-4 py-2 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700"
					:class="{ 'bg-gray-100 dark:bg-gray-700': locale.code === locale }"
					role="menuitem" @click="switchLanguage(locale.code)">
					{{ locale.name }}
				</button>
			</div>
		</div>

<template>
  ...
  >
    <div class="relative w-[90vw] h-[90vh] max-w-6xl max-h-[90vh] flex">
      ...
      >
        <!-- Thread header -->
        <div class="p-4 border-b border-gray-200 rounded-r-xl dark:border-gray-800 flex items-center sticky top-0 bg-white dark:bg-gray-900 z-10">
        ...
        <!-- Add comment input -->
        <div class="p-4 border-t border-gray-200 rounded-r-xl dark:border-gray-800 sticky bottom-0 bg-white dark:bg-gray-900">

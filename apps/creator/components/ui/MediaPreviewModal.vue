        ...
        <Swiper v-if="mediaItems.length > 0" :modules="[Navigation, Keyboard]" :initial-slide="currentIndex"
          ...
          <SwiperSlide v-for="(media, index) in mediaItems" :key="index">
            <div class="w-full h-full flex items-center justify-center">
              ...
              <video v-else-if="media.type === 'video'" ref="videoPlayer" :src="media.url" controls
      ...
      <div v-if="showSidebar"
        ...
        <div
          ...
          <div class="flex items-center">
            ...
            <button class="ml-2 text-primary-600 dark:text-primary-400 font-semibold text-sm disabled:opacity-50"

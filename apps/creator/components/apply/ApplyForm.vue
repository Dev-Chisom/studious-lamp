<template>
  <Form v-slot="{ errors, meta, values, setFieldValue }" :validation-schema="applyFormSchema"
    :initial-values="initialValues" class="space-y-8" validate-on-input @submit="onSubmit">
    <!-- Basic Information -->
    <section>
      ...
      <div class="space-y-6">
        ...
        <Field v-slot="{ field, meta, handleChange }" name="bio">
          <div>
            ...
            <textarea v-bind="field" rows="3" :placeholder="t('apply.basicInfo.bioPlaceholder')"
              ...
              :class="{ 'border-error-500': meta.touched && errors.bio }" @input="(e) => {
                field.onChange(e);
                handleChange(e);
              }" />
    ...
    <section class="pt-8 border-t border-gray-200 dark:border-gray-700">
      <div class="flex items-start">
        <Field v-slot="{ field, errorMessage, meta }" name="acceptTerms" type="checkbox" :value="true"
          :unchecked-value="false">
          <div class="flex items-start mt-2">
            <div class="flex items-center h-5">
              <input id="accept-terms" type="checkbox" v-bind="field"
      ...
      <Field v-slot="{ field, errorMessage, meta }" name="confirmAge" type="checkbox" :value="true"
        :unchecked-value="false" class="mt-4">
        <div class="flex items-start mt-2">
          <div class="flex items-center h-5">
            <input id="confirm-age" type="checkbox" v-bind="field"
              class="h-4 w-4 rounded border-gray-300 text-primary-600 focus:ring-primary-500" />
          </div>
          <div class="ml-3 text-sm">
    ...
    <div class="pt-6 flex justify-end">
      <button type="submit" :disabled="!meta.valid || apiLoading"

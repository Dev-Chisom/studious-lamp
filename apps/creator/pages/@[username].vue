              ...
              <PostCard
                ...
                :post="{
                  ...
                  creator: {
                    ...
                    avatar: user?.profileImage || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.displayName || 'Unknown User')}&background=random`
                  },
                  ...
                  comments: post.comments.map(comment => ({
                    ...
                    user: {
                      ...
                      avatar: comment.user?.avatar || `https://ui-avatars.com/api/?name=${encodeURIComponent(comment?.user?.name || 'Anonymous')}&background=random`
                    },

					...
					<div class="sm:flex sm:items-end sm:space-x-5 px-6">
						<div class="flex">
							<div class="avatar h-32 w-32 ring-4 ring-white">
								<img
									v-if="user?.profileImage" :src="user?.profileImage" alt="Profile"
							...
							<div class="space-y-6">
								...
								<div class="border-t border-gray-200 pt-6">
									...
									<div class="mt-4 space-y-3">
										<a
											v-for="social in user?.social || []" :key="social.platform" :href="social.url" target="_blank"
						...
						<div v-if="isCurrentUser" class="bg-white dark:bg-gray-900 shadow-sm rounded-lg p-6">
							<div class="flex space-x-3">
								...
								<div class="min-w-0 flex-1">
									<textarea
										v-model="newPost" rows="3" class="form-input"

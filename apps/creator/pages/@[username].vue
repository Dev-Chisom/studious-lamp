        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
              ...
              <div class="space-y-6">
                ...
                <div class="border-t border-gray-200 pt-6">
                  ...
                  <div class="mt-4 space-y-3">
                    <a v-for="social in user?.social || []" :key="social.platform" :href="social.url" target="_blank"
                ...
                <button v-if="!isCurrentUser" class="btn-primary w-full" @click="followUser">
                  <Icon :name="isFollowing ? 'lucide:user-minus' : 'lucide:user-plus'" class="h-5 w-5 mr-2" />
                  {{ isFollowing ? 'Unsubscribe' : 'Subscribe' }}
                </button>
              </div>
          ...
          <div class="lg:col-span-2 space-y-6">
            ...
            <div v-if="isCurrentUser" class="bg-white dark:bg-gray-900 shadow-sm rounded-lg p-6">
              <div class="flex space-x-3">
                ...
                <div class="min-w-0 flex-1">
                  <textarea v-model="newPost" rows="3" class="form-input"
            ...
            <div v-if="posts.length > 0" class="space-y-6">
              <post-card v-for="post in posts" :key="post.id" :post="{
                id: post.id,
                creator: {
              ...
              }" :is-subscribed="isSubscribed" @subscribe="handleSubscribe" @tip="handleTip" />
            </div>

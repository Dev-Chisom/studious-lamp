<template>
  <div class="container mx-auto max-w-6xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3">
          ...
          <div class="border-r border-gray-200 dark:border-gray-700">
            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
              <form-input v-model="searchQuery" :placeholder="$t('messages.search')" icon="lucide:search"
                ...
                <div v-for="message in selectedChat.messages" :key="message.id" class="flex"
                  ...
                  <div class="max-w-[70%] rounded-lg px-4 py-2" :class="message.isSelf
                    ...
                    <div class="flex items-center justify-end mt-1 space-x-1">
                      ...
                      <!-- Read receipt -->
                      <Icon v-if="message.isSelf" :name="message.isRead ? 'lucide:check-check' : 'lucide:check'"
                ...
                <form class="space-y-4" @submit.prevent="sendMessage">
                  ...
                  <div v-if="mediaPreview.length > 0" class="flex space-x-2 overflow-x-auto pb-2">
                    <div v-for="(media, index) in mediaPreview" :key="index" class="relative flex-shrink-0">
                      ...
                      <video v-else-if="media.type === 'video'" :src="media.preview" controlsList="nodownload"
                        class="h-20 w-20 object-cover rounded-lg dark:border dark:border-gray-700" />
                      <button
                  ...
                  <div class="flex space-x-2">
                    <form-input v-model="newMessage" :placeholder="$t('messages.typeMessage')"
    ...
    <!-- Media preview modal -->
    <media-preview-modal v-if="mediaModal.isOpen" :is-open="mediaModal.isOpen" :media-items="mediaModal.mediaItems"

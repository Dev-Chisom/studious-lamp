  ...
  <div class="max-w-6xl mx-auto">
    ...
    <div class="flex justify-between items-center mb-8">
      ...
      <h1 class="text-2xl font-bold text-gray-900">				My Collections 			</h1>
      			<button variant="primary" @click="showNewCollectionModal = true">				New Collection 			 			</button> 		 		 		
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-4">
          ...
          <div class="grid grid-cols-2 gap-2">
            ...
            <div v-for="(post, index) in collection.posts.slice(0, 4)" :key="index" class="aspect-square">
          					...
          					<button variant="outline" class="w-full" @click="viewCollection(collection)">						View Collection 					 					</button> 				 				 				
        </div>
        			</Card
      >
      ...
      <div class="p-6">
        ...
        <div class="space-y-4">
          ...
          <div>
            						<label class="block text-sm font-medium text-gray-700 mb-1">Collection Name</label> 						<input
            ...
            />
          					...
          					<button :loading="isCreating" variant="primary" class="w-full" @click="createNewCollection">
            						Create Collection 					 					 					
          </button>

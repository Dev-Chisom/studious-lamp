    ...
    <div class="sm:flex sm:items-center sm:justify-between mb-6">
      ...
      <div class="mt-4 sm:mt-0">
        				<NuxtLink to="/creator/content/new" class="btn-primary">
          					<Icon name="lucide:plus" class="mr-2 h-4 w-4" /> 					Create New Post 				</NuxtLink
        >
            ...
            <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
              ...
              >
                ...
                <td class="px-6 py-4">
                  ...
                  >
                    										{{ post.visibility === 'ppv' ? 'Pay-per-view' : post.visibility }} 									</span
                  >
                ...
                <td class="px-6 py-4">
                  ...
                  <div class="text-sm text-gray-900 dark:text-gray-100 space-y-1">
                    ...
                    <div class="flex items-center">
                      											<Icon name="lucide:eye" class="h-4 w-4 text-gray-400 dark:text-gray-100 mr-1" /> 											<span
                    ...
                    <div class="flex items-center">
                      											<Icon name="lucide:heart" class="h-4 w-4 text-gray-400 dark:text-gray-100 mr-1" /> 											<span
                        class="text-gray-400 dark:text-gray-100"
                    ...
                    <div class="flex items-center">
                      											<Icon name="lucide:message-square" class="h-4 w-4 text-gray-400 dark:text-gray-100 mr-1" /> 											<span
                        class="text-gray-400 dark:text-gray-100"
              ...
              <div>
                ...
                <p class="text-sm text-gray-700 dark:text-gray-300">
                    ...
                    endIndex
                  									...
                  									of 									<span class="font-medium">{{ totalPosts }}</span> 									results 								 								 								
                </p>

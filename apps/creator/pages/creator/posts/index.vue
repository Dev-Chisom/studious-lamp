	...
	<div class="max-w-6xl mx-auto">
		...
		<div class="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-4 mb-6">
			<div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
				<FormInput
					v-model="filters.search" placeholder="Search posts..." icon="lucide:search"
				...
				<div class="overflow-x-auto">
					<table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
						...
						<tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
							<tr
								v-for="post in filteredPosts.slice(startIndex, endIndex)" :key="post.id"
								...
								<td class="px-6 py-4">
									<div class="flex items-center">
										<div class="h-10 w-10 flex-shrink-0">
											<img
												v-if="post.mediaUrls && post.mediaUrls[0]" :src="post.mediaUrls[0]" :alt="post.title"

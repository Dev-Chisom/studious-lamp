            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="flex items-center">
                ...
                <h3 class="text-sm font-medium text-gray-900 dark:text-gray-100 truncate">									{{ post.title }} 								 								</h3>
                								...
                								<span v-else class="ml-2 badge badge-success"> Public </span> 								<span
              ...
              <div class="mt-2 flex items-center text-xs text-gray-500 dark:text-gray-200 dark:text-gray-400 space-x-4">
                								<span class="flex items-center">
                  									<Icon name="lucide:calendar" class="h-4 w-4 mr-1" /> 									{{ formatDate(post.createdAt) }} 								</span
                >
                								<span class="flex items-center">
                  									<Icon name="lucide:heart" class="h-4 w-4 mr-1" /> 									{{ post.likes }} 								</span
                >
                								<span class="flex items-center">
                  									<Icon name="lucide:message-square" class="h-4 w-4 mr-1" /> 									{{ post.comments }} 								</span
                >
                								<span v-if="post.price" class="flex items-center">
                  									<Icon name="lucide:dollar-sign" class="h-4 w-4 mr-1" /> 									{{ post.price }} 								</span
                >

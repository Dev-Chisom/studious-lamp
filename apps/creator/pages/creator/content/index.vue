        ...
        <li v-for="post in filteredPosts" :key="post.id" class="hover:bg-gray-50 hover:dark:bg-gray-700">
          <div class="px-4 py-4 sm:px-6 flex items-center">
            <div class="w-16 h-16 flex-shrink-0 rounded overflow-hidden bg-gray-100 mr-4">
              <img v-if="post.mediaUrls && post.mediaUrls.length > 0" :src="post.mediaUrls[0]" :alt="post.title"
            ...
            <div class="min-w-0 flex-1">
              <div class="flex items-center">
                ...
                <span v-if="post.visibility === 'subscribers'" class="ml-2 badge badge-primary">
                  Subscribers
                </span>
                <span v-else-if="post.visibility === 'ppv'" class="ml-2 badge badge-secondary">
                  Pay-per-view
                </span>
                <span v-else class="ml-2 badge badge-success">
                  Public
                </span>
                <span v-if="post.scheduledFor" class="ml-2 badge badge-warning">
                  Scheduled
                </span>
              </div>

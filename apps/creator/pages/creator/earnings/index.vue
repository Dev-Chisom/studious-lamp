<template>
  ...
  <div class="max-w-6xl mx-auto">
    		<Head> 			<Title>Earnings - Creator Dashboard</Title> 		</Head>
      ...
      <div class="p-6">
        ...
        <div class="h-72 bg-gray-50 dark:bg-gray-600 rounded-lg flex items-center justify-center">
          ...
          <p class="text-gray-500 dark:text-gray-200">
            						Chart placeholder - In a real app, implement chart using a library 						like Chart.js 					 					 					
          </p>
    ...
    <div class="bg-white dark:bg-gray-900 shadow-sm rounded-lg">
      ...
      <div class="p-6">
        ...
        <div class="sm:flex sm:items-center sm:justify-between mb-6">
          ...
          <div class="mt-3 sm:mt-0">						<button class="btn-outline">							Download CSV 						</button> 					 					</div>
              ...
              >
                ...
                <td class="px-6 py-4 whitespace-nowrap">
                  ...
                  <div class="text-xs text-gray-500 dark:text-gray-200 dark:text-gray-400">
                    										After fees: ${{ (transaction.amount * 0.8).toFixed(2) }} 									 									 									
                  </div>
        ...
        <div class="mt-6 flex items-center justify-between">
          ...
          <div class="flex-1 flex justify-between sm:hidden">
            						<button class="btn-outline" :disabled="currentPage === 1" @click="currentPage--">							Previous 						 						</button> 						<button
              class="btn-outline"
            ...
            <div>
              ...
              <p class="text-sm text-gray-700">
                  ...
                  endIndex
                								...
                								of 								<span class="font-medium">{{ totalTransactions }}</span> 								results 							 							 							
              </p>

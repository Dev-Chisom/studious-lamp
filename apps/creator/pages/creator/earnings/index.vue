      ...
      <div class="p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="space-y-4">
              <div v-for="item in revenueByType" :key="item.name" class="flex items-center sm:flex-col md:flex-row">
                <div class="w-full bg-gray-200 rounded-full h-2.5">
                  <div class="h-2.5 rounded-full" :class="`bg-${item.color}-500`"
          ...
          <div>
            ...
            <div class="space-y-4">
              <div v-for="item in revenueBySubscription" :key="item.name"
      ...
      <div class="p-6">
        ...
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            <thead>
              <tr>
                <th v-for="(label, key) in transactionHeaders" :key="key"

            ...
            <div class="p-6">
              ...
              <div class="mt-4 space-y-2">
                ...
                <div class="flex justify-between text-sm">
                  									<span class="text-gray-500 dark:text-gray-200">Plan</span> 									<span class="font-medium">{{
                ...
                <div class="flex justify-between text-sm">
                  									<span class="text-gray-500 dark:text-gray-200">Price</span> 									<span class="font-medium"
                ...
                <div class="flex justify-between text-sm">
                  									<span class="text-gray-500 dark:text-gray-200">Next billing date</span> 									<span class="font-medium">{{
                ...
                <div class="flex justify-between text-sm">
                  									<span class="text-gray-500 dark:text-gray-200">Auto-renew</span> 									<span
                    :class="subscription.autoRenew ? 'text-success-600' : 'text-error-600'"
                  >
                    										{{ subscription.autoRenew ? 'Enabled' : 'Disabled' }} 									</span
                  >

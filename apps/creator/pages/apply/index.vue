<template>
  ...
  <div class="min-h-screen max-w-6xl mx-auto">
    		<Head> 			<Title>Become a Creator - Creator Dashboard</Title> 		</Head> 		 		 		
          ...
          <div class="p-6 sm:p-8">
            ...
            <form class="space-y-8" @submit.prevent="submitApplication">
                ...
                <div class="space-y-6">
                  ...
                  <div>
                    										<label class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
                      											Bio 											<span class="text-error-500">*</span> 										</label
                    >
                    										<textarea
                      v-model="form.bio"
                      rows="3"
                  ...
                  <div>
                    										<label class="block text-sm font-medium text-gray-900 dark:text-gray-100 mb-2">
                      											Categories 											<span class="text-error-500">*</span> 										</label
                    >
                  ...
                  <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                      											<label for="terms" class="font-medium text-gray-700 dark:text-gray-300">
                        												I agree to the 												<a
                          href="https://studious-lamp-web.vercel.app/terms"
                          target="_blank"
                        ...
                        >
                        												and 												<a
                          href="https://studious-lamp-web.vercel.app/privacy"
                          target="_blank"
                          class="text-primary-600 hover:text-primary-500"
                        >
              ...
              <div class="pt-6 flex justify-end">
                ...
                >
                  									<span v-if="isSubmitting">Submitting...</span> 									<span v-else>Submit Application</span> 								 								 								
                </button>

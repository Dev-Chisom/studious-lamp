      ...
      <header class="h-16 bg-white border-b border-gray-200">
        ...
        <div class="flex items-center justify-between h-full px-6">
          ...
          <div class="flex items-center space-x-4">
            						<button class="text-gray-500 hover:text-gray-700">							<Icon name="lucide:bell" class="h-5 w-5" /> 						 						</button>
            						<button class="text-gray-500 hover:text-gray-700">							<Icon name="lucide:settings" class="h-5 w-5" /> 						 						</button>
            						 						 						
            <div class="relative">
              							<button class="flex items-center space-x-2 text-gray-700" @click="userMenuOpen = !userMenuOpen">
                ...
                <div class="avatar h-8 w-8">
                  ...
                  />
                								...
                								<span class="text-sm font-medium">Admin User</span> 								<Icon name="lucide:chevron-down" class="h-4 w-4" /> 							
                							 							
              </button>

              							 							 							
              <div v-if="userMenuOpen" class="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg py-1 z-50">
                								<a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100"> 									Profile 								</a> 								<a
                  href="#"

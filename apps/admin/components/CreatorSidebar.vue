<template>
  ...
  <div>
    ...
    <div v-if="isMobileOpen" class="fixed inset-0 z-40 lg:hidden" role="dialog" aria-modal="true">
      			<!-- Background overlay -->
      			 			 			
      <div class="fixed inset-0 bg-gray-600 bg-opacity-75" @click="$emit('close')" />
          ...
          <div class="px-4 py-6 bg-primary-700 sm:px-6">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-2">
                								<img src="/logo-white.svg" alt="Whispers" class="h-8 w-auto" /> 								<span
                  class="text-xl font-bold text-white"
                  >Creator Studio</span
                >
                							 							 							
              </div>
              							<button type="button" class="text-white hover:text-gray-200" @click="$emit('close')">
      ...
      <div class="flex flex-col w-64">
        ...
        <div class="flex flex-col h-0 flex-1">
          ...
          <div class="px-4 py-6 bg-primary-700 flex items-center">
            ...
            <div class="flex items-center space-x-2">
              							<img src="/logo-white.svg" alt="Whispers" class="h-8 w-auto" /> 							<span class="text-xl font-bold text-white"
                >Creator Studio</span
              >
          ...
          <div class="flex-1 flex flex-col overflow-y-auto">
            ...
            <nav class="flex-1 px-2 py-4 space-y-1">
              							<SidebarNavigationItem v-for="item in navigationItems" :key="item.name" :item="item" /> 						 						 						
            </nav>

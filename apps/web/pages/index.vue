  ...
  <div>
    ...
    <section class="relative bg-gradient-to-b from-primary-700 to-primary-900 text-white">
      ...
      <div class="absolute inset-0 overflow-hidden">
        ...
        <div class="absolute inset-0 bg-gradient-to-r from-primary-900/80 to-primary-700/70" />
        				<img
      ...
      <div class="relative container mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
        ...
        <div class="max-w-3xl">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            						<NuxtLink to="/explore" class="btn-secondary"> 							Explore Creators 						</NuxtLink> 						<a
              href="https://studious-lamp-creator.vercel.app/auth/register"
              target="_blank"
              class="btn-outline border-white text-black hover:bg-white/10"
            >
              							Become a Creator 						</a
            >
    ...
    <section class="py-12 sm:py-16 bg-white">
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mt-10">
          					<NuxtLink to="/explore" class="btn-outline"> 						View All Creators 					</NuxtLink> 				 				 				
        </div>
      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">							Browse and follow your favorite creators from various categories. 						 						</p>
          ...
          <div class="text-center">
            ...
            <p class="text-gray-600">							Subscribe to unlock exclusive content and support your favorite 							creators. 						 						</p>
        ...
        <div class="lg:flex lg:items-center lg:justify-between">
          ...
          <div class="lg:max-w-xl">
            ...
            <p class="mt-3 text-lg text-white/80 max-w-2xl">
              							Join thousands of creators who are earning directly from their 							fans. Start sharing your content and
...
const testimonials = [
  {
    ...
    quote:
      'Whispers has completely changed my business. I can now share workout routines and nutrition plans directly with my subscribers and earn from my expertise.',
  },
  {
    name: 'David Chen',
    ...
    quote:
      'As an artist, I was struggling to monetize my work. With Whispers, I can share my process, tutorials, and exclusive artwork with fans who truly value my creativity.',
  },
  {

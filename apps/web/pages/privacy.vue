  ...
  <div class="container mx-auto px-4 py-12">
    <div class="max-w-3xl mx-auto">
      ...
      <div class="prose prose-lg">
        ...
        <p>
          This Privacy Policy explains how Whispers collects, uses, and protects your personal information when you use our platform.
        </p>
        ...
        <h2>7. Cookies</h2>
        <p>
          We use cookies and similar technologies to improve your experience and collect usage data. You can control cookie settings through your browser.
        </p>
        ...
        <p>
          We may update this policy periodically. We will notify you of significant changes through the platform or email.
        </p>
        ...
        <p>
          ...
          <br />
          Email: privacy@whispers.example.com
          <br />

    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-8">
        ...
        <p class="mt-2 text-lg text-gray-600">
          Discover and follow amazing creators from various categories
        </p>
      </div>
      ...
      <div class="mb-8 bg-white rounded-lg shadow-sm p-4 lg:p-6">
        ...
        <div class="mt-4 flex flex-wrap gap-2">
          <button
            ...
            :class="selectedCategory === category ? 'bg-primary-100 text-primary-800' : 'bg-gray-100 text-gray-800 hover:bg-gray-200'"
            ...
            <div class="flex flex-col h-full">
              ...
              <div class="px-4 py-4 border-t border-gray-100 mt-auto">
                <div class="flex items-center justify-between">
                  <div class="text-sm">
                    <span class="font-semibold">{{ creator.subscriberCount.toLocaleString() }}</span>
                    <span class="text-gray-500 ml-1">fans</span>
                  </div>
                  <div>
                ...
                <div class="mt-3">
                  <NuxtLink :to="`/creators/${creator.username}`" class="btn-primary w-full">
                    View Profile
                  </NuxtLink>
                </div>
              </div>
...
const filteredCreators = computed(() => {
  ...
  if (selectedCategory.value) {
    result = result.filter(creator => 
      creator.categories.includes(selectedCategory.value)
    );
  }

          ...
          <div class="p-6 sm:p-8">
            ...
            <div class="grid gap-8 md:grid-cols-2">
              ...
              <div class="border rounded-lg p-6">
                ...
                <ul class="space-y-3 mb-6">
                  <li class="flex items-center text-sm">
                    <Icon name="lucide:check" class="h-5 w-5 text-success-500 mr-2" />
              ...
              <div v-if="creator.yearlyPrice" class="border rounded-lg p-6 relative overflow-hidden">
                <div class="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 bg-secondary-500 text-white text-xs font-bold py-1 px-3 rounded-full transform rotate-45">
                  Best Value
                </div>
      ...
      <div class="max-w-4xl mx-auto">
        ...
        <div class="my-8 text-center">
          <p class="text-gray-500 mb-4">
            Subscribe to see {{ creator.postCount - previewPosts.length }} more posts
          </p>
...
const creator = computed(() => {
  return subscriptionStore.creators.find(c => c.username === route.params.username) || {
    id: '404',
...
const calculateYearlySavings = computed(() => {
  if (!creator.value.yearlyPrice || !creator.value.monthlyPrice) return 0;

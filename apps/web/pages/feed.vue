    ...
    <div class="max-w-2xl mx-auto">
      ...
      <div class="mb-8 flex items-center justify-between">
        ...
        <h1 class="text-2xl font-bold">					Your Feed 				</h1>
        				<button class="btn-outline" @click="sortBy = sortBy === 'latest' ? 'popular' : 'latest'">
          					<Icon :name="sortBy === 'latest' ? 'lucide:clock' : 'lucide:trending-up'" class="h-5 w-5 mr-2" /> 					{{
      ...
      <div v-else-if="posts.length === 0" class="text-center py-12 bg-white rounded-lg shadow-sm">
        ...
        <p class="mt-1 text-gray-500">					Subscribe to creators to see their posts in your feed. 				 				</p>
      ...
      <div v-else class="space-y-6">
        ...
        <div v-for="post in sortedPosts" :key="post.id" class="bg-white rounded-lg shadow-sm overflow-hidden">
          					<!-- Post header -->
          ...
          <div class="p-4 flex items-center space-x-3">
            ...
            <div class="flex-1 min-w-0">
              ...
              <div class="flex items-center">
                								<NuxtLink :to="`/creators/${post.creator.username}`" class="font-medium hover:text-primary-600">
                  									{{ post.creator.displayName }} 								</NuxtLink
                >
          ...
          <div v-if="post.media && post.media.length > 0" class="relative">
            ...
            <div class="relative">
              ...
              <div
                ...
                :style="{
                  transform: `translateX(-${activeSlide[post.id] * 100}%)`,
                }"
              >
                								 								 								
                <div v-for="(media, index) in post.media" :key="index" class="w-full flex-shrink-0">
                  									<!-- Image -->
                  									<img
              ...
              <div v-if="post.media.length > 1" class="absolute bottom-2 left-1/2 -translate-x-1/2 flex space-x-1">
                								<button
          ...
          <div class="px-4 py-3 border-t border-gray-100">
            ...
            <div class="flex items-center justify-between">
              ...
              <div class="flex items-center space-x-4">
                								<button class="flex items-center text-gray-500 hover:text-primary-600" @click="toggleLike(post)">
                  									<Icon
                  ...
                  />
                								...
                								<button class="flex items-center text-gray-500 hover:text-gray-600" @click="showComments(post)">
                  									<Icon name="lucide:message-circle" class="h-5 w-5 mr-1" /> 									<span class="text-sm">{{
              ...
              <div v-if="post.visibility === 'subscribers'" class="badge badge-primary">								Subscribers Only 							 							</div>
                  ...
                  <div v-for="comment in post.comments" :key="comment.id" class="flex space-x-3">
                    ...
                    <div class="flex-1">
                      ...
                      <div class="mt-1 flex items-center space-x-2 text-xs text-gray-500">
                        												<span>{{ formatTime(comment.createdAt) }}</span> 												<button class="hover:text-primary-600">
                          													Like 												 												 												
                        </button>
      ...
      <div v-if="hasMorePosts" class="mt-8 text-center">
        				<button class="btn-outline" :disabled="loadingMore" @click="loadMorePosts">
          					<Icon v-if="loadingMore" name="lucide:loader" class="animate-spin h-5 w-5 mr-2" /> 					Load More 				 				 				
        </button>
...
const posts = ref([
  {
    ...
    content:
      'Just wrapped up an amazing photoshoot! Here are some exclusive behind-the-scenes shots for my subscribers. 📸✨',
    media: [
      {
        type: 'image',
